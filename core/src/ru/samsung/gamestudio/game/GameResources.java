...
public class GameResources {
    ...
    public static final String PLAYER_TILESET_PATH = "texture/player/hero-tileset.png";
    public static final String ENEMY_TILESET_PATH = "texture/enemy/enemy-tileset.png";
